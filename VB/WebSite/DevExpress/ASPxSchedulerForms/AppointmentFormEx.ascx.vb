...
Public Partial Class AppointmentFormEx
	...
	Protected Overrides Function GetChildEditors() As ASPxEditBase()
		Dim edits As ASPxEditBase() = New ASPxEditBase() { lblSubject, tbSubject, lblLocation, tbLocation, lblLabel, edtLabel, lblStartDate, edtStartDate, lblEndDate, edtEndDate, lblStatus, edtStatus, lblAllDay, chkAllDay, lblResource, edtResource, tbDescription, cbReminder, ddResource }
		Return edits
	End Function
	Protected Overrides Function GetChildButtons() As ASPxButton()
		Dim buttons As ASPxButton() = New ASPxButton() { btnOk, btnCancel, btnDelete }
		Return buttons
	End Function
	...
	Protected Sub RenderRecurrenceControl(ByVal isRecurring As Boolean)
		If Not Me.recurrenceControl_Renamed Is Nothing Then
