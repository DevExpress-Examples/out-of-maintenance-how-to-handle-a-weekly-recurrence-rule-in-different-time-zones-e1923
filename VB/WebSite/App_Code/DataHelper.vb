...
Public Class DataHelper
	...
	Public Shared Sub ProvideRowInsertion(ByVal control As ASPxScheduler, ByVal dataSource As DataSourceControl)
		...
		If Not accessDataSource Is Nothing Then
			Dim provider As AccessRowInsertionProvider = New AccessRowInsertionProvider()
		...
		If Not objectDataSource Is Nothing Then
			Dim provider As ObjectDataSourceRowInsertionProvider = New ObjectDataSourceRowInsertionProvider()
...
Public Class AccessRowInsertionProvider
	...
	Private Sub AppointmentsDataSource_Inserted(ByVal sender As Object, ByVal e As SqlDataSourceStatusEventArgs)
		...
		Using cmd As OleDbCommand = New OleDbCommand("SELECT @@IDENTITY", connection)
