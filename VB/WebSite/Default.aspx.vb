...
Public Class MyAppointmentFormController
	...
	Public Sub New(ByVal control As ASPxScheduler, ByVal apt As DevExpress.XtraScheduler.Appointment)
		...
		If Not EditedPattern Is Nothing AndAlso EditedPattern.RecurrenceInfo.Type = RecurrenceType.Weekly Then
	...
	Protected Overridable Function DetectCrossDayTransition(ByVal pattern As Appointment) As Integer
		Dim helper As TimeZoneHelper = New TimeZoneHelper(Control.OptionsBehavior.ClientTimeZoneId)
		Dim serverTime As DateTime = EditedPattern.Start
		Dim clientTime As DateTime = helper.ToClientTime(EditedPattern.Start)
